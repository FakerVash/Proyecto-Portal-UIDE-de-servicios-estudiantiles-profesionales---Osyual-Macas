...
export class PedidoService {
    ...
    async createPedido(data: any, clienteId: number) {
        ...
        const subtotal = parseFloat(servicio.precio.toString());
    ...
    async addResena(pedidoId: number, data: any, clienteId: number) {
